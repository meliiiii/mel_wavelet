...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.discriminator = nn.ModuleList([
            ...
            #decoder_sequential(1, 8, kernel_size=41, stride=4, padding=20, groups=1),
            #decoder_sequential(8, 64, kernel_size=41, stride=4, padding=20, groups=4),
            #decoder_sequential(64, 512, kernel_size=41, stride=4, padding=20, groups=16),
            #decoder_sequential(512, 512, kernel_size=41, stride=4, padding=20, groups=64),
            # Feature map x 1
            nn.Sequential(
